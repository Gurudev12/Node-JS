...
import {openDrawer,changeView } from '../action/action';
        ...
        return (
            <MuiThemeProvider theme={theme}>
                <div className="dashboard">
                                ...
                                <div className="rightItems" >
                                    <MuiThemeProvider theme={theme}>
                                        ...
                                        <IconButton onClick={this.handleViewChange}>
                                            {this.props.view === true ? <img src={listview} alt="" /> : <img src={gridview} alt="" />}
                                        </IconButton>
                    ...
                    <DrawerList perticularNotesProps={this.handleGetAllNote} labelArray={this.handleLabelArray} handleLabelNote={this.handleLabelNote} />
...
console.log("VIEEW VALUE IN DASHBOARD",state.view);
