/******************************************************************************
 *  
 *  @Purpose: Address  Book class contain all implementation details
 *
...
class AddressBook
{
    ...
    addPerson(addressData)
    {
        ...
        //name validation
        if(format.test(fname)==false) throw "name should not be number"

        console.log("Enter last name")
        let lname=input.question()
        //last name validation
        if(format.test(lname)==false) throw " last name should not be number"
